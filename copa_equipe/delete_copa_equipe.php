...
<body>
	<h1><center>Menu: Deletar Copa_Equipe</center></h1>
			...
			if($result->num_rows > 0 ) {
				while($row = $result->fetch_assoc()) {
					echo "<tr>
						...
						<td>
							<a href='remove_copa_equipe.php?cod_equipe=".$row['cod_equipe']." & ano_copa=".$row['ano_copa']."'><button type='button'>Remover Dados</button></a>
						</td>
					</tr>";
				}
			} else {
