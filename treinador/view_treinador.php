...
<body>
	<h1> <center> Menu: Visualizar Treinador  </center> </h1>
<div class="manageMember">
	...
	<table border="2" cellspacing="3" cellpadding="5">
		...
		<tbody>
			<?php
			$sql = "SELECT pessoa.nome_pessoa, treinador.cod_treinador, treinador.cod_pessoa FROM treinador, pessoa WHERE treinador.cod_treinador = pessoa.cod_pessoa";
